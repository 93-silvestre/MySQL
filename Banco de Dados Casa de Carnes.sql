...
select * from tb_produtos where nome like "ha%"; -- localizar qualquer nome que comece com ha e teermine com qualquer coisa

select * from tb_produtos where nome like "%ha";

select * from tb_produtos where nome like "%ha%";

select * from tb_produtos where preco in (20.00 , 30.00, 40.00); -- indica os intervalos

select * from tb_produtos where preco between 20.00 and 40.00 order by preco desc; -- indica entre eles
